	...
	<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--60 sui-spacing-bottom--30">
		...
		>
			...
			printf(
				...
				count( $templates ),
				'<a href="https://premium.wpmudev.org/docs/wpmu-dev-plugins/hustle/#choosing-a-template?utm_source=hustle&utm_medium=plugin&utm_campaign=choose_template_learnmore_link" target="_blank">',
				'</a>'
			);
			?>
		</p>
